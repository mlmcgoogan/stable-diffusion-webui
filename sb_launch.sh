...
python launch.py --xformers --listen --device-id $SD_DEVICE --port $SD_PORT --api --enable-insecure-extension-access --vae-path $MODEL_PATH/improved_faces.vae.pt &> $LOG_FILENAME &
